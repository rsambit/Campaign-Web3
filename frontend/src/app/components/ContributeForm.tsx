...
export const ContributeForm = (props: IContributeFormProps) => {
    ...
    const depositAmount = async () => {
        try {
            ...
            toast(`Deposited ${amount} ETH successfully.`);

            onContributionDone();

        } catch (e) {
            toast(`Error depositing ${amount} ETH: ${(e as any)?.message}`);
        }
    }
